...
class OrderApi(object):
    ...
    def retrieve_order(self, location_id, order_id, **kwargs):
        """
        RetrieveOrder
        Retrieves details for a single [Order](#type-order).
        ...
        :param str order_id: The ID of the order to retrieve. (required)
        ...
        resource_path = '/v2/locations/{location_id}/orders/{order_id}'.replace('{format}', 'json')
        path_params = {}
        if 'location_id' in params:
            path_params['location_id'] = params['location_id']
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='RetrieveOrderResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
