...
class TransactionsApi(object):
    ...
    def v1_create_refund(self, location_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_create_refund(location_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v1_create_refund" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_create_refund`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_create_refund`")
    ...
    def v1_list_bank_accounts(self, location_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_bank_accounts(location_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_bank_accounts" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_list_bank_accounts`")
    ...
    def v1_list_orders(self, location_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_orders(location_id, callback=callback_function)
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_list_orders`")

        if 'limit' in params and params['limit'] > 200:
            raise ValueError("Invalid value for parameter `limit` when calling `v1_list_orders`, must be a value less than or equal to  `200`")
    ...
    def v1_list_payments(self, location_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_payments(location_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_payments" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_list_payments`")

        if 'limit' in params and params['limit'] > 200:
            raise ValueError("Invalid value for parameter `limit` when calling `v1_list_payments`, must be a value less than or equal to  `200`")
    ...
    def v1_list_refunds(self, location_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_refunds(location_id, callback=callback_function)
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_list_refunds`")

        if 'limit' in params and params['limit'] > 200:
            raise ValueError("Invalid value for parameter `limit` when calling `v1_list_refunds`, must be a value less than or equal to  `200`")
    ...
    def v1_list_settlements(self, location_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_settlements(location_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_settlements" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_list_settlements`")

        if 'limit' in params and params['limit'] > 200:
            raise ValueError("Invalid value for parameter `limit` when calling `v1_list_settlements`, must be a value less than or equal to  `200`")
    ...
    def v1_retrieve_bank_account(self, location_id, bank_account_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_bank_account(location_id, bank_account_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_bank_account" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_retrieve_bank_account`")
        # verify the required parameter 'bank_account_id' is set
        if ('bank_account_id' not in params) or (params['bank_account_id'] is None):
            raise ValueError("Missing the required parameter `bank_account_id` when calling `v1_retrieve_bank_account`")
    ...
    def v1_retrieve_order(self, location_id, order_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_order(location_id, order_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_order" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_retrieve_order`")
        # verify the required parameter 'order_id' is set
        if ('order_id' not in params) or (params['order_id'] is None):
            raise ValueError("Missing the required parameter `order_id` when calling `v1_retrieve_order`")
    ...
    def v1_retrieve_payment(self, location_id, payment_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_payment(location_id, payment_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_payment" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_retrieve_payment`")
        # verify the required parameter 'payment_id' is set
        if ('payment_id' not in params) or (params['payment_id'] is None):
            raise ValueError("Missing the required parameter `payment_id` when calling `v1_retrieve_payment`")
    ...
    def v1_retrieve_settlement(self, location_id, settlement_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_settlement(location_id, settlement_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_settlement" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_retrieve_settlement`")
        # verify the required parameter 'settlement_id' is set
        if ('settlement_id' not in params) or (params['settlement_id'] is None):
            raise ValueError("Missing the required parameter `settlement_id` when calling `v1_retrieve_settlement`")
    ...
    def v1_update_order(self, location_id, order_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_update_order(location_id, order_id, body, callback=callback_function)
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_update_order`")
        # verify the required parameter 'order_id' is set
        if ('order_id' not in params) or (params['order_id'] is None):
            raise ValueError("Missing the required parameter `order_id` when calling `v1_update_order`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_update_order`")
