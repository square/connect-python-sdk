...
class EmployeesApi(object):
    ...
    def v1_create_employee(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_create_employee(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v1_create_employee" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_create_employee`")
    ...
    def v1_create_employee_role(self, employee_role, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_create_employee_role(employee_role, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_create_employee_role" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('employee_role' not in params) or (params['employee_role'] is None):
            raise ValueError("Missing the required parameter `employee_role` when calling `v1_create_employee_role`")
    ...
    def v1_create_timecard(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_create_timecard(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_create_timecard" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_create_timecard`")
    ...
    def v1_delete_timecard(self, timecard_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_delete_timecard(timecard_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_delete_timecard" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('timecard_id' not in params) or (params['timecard_id'] is None):
            raise ValueError("Missing the required parameter `timecard_id` when calling `v1_delete_timecard`")
    ...
    def v1_list_cash_drawer_shifts(self, location_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_cash_drawer_shifts(location_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_cash_drawer_shifts" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_list_cash_drawer_shifts`")
    ...
    def v1_list_employee_roles(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_employee_roles(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_employee_roles" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'limit' in params and params['limit'] > 200:
            raise ValueError("Invalid value for parameter `limit` when calling `v1_list_employee_roles`, must be a value less than or equal to  `200`")
    ...
    def v1_list_employees(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_employees(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_employees" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'limit' in params and params['limit'] > 200:
            raise ValueError("Invalid value for parameter `limit` when calling `v1_list_employees`, must be a value less than or equal to  `200`")
    ...
    def v1_list_timecard_events(self, timecard_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_timecard_events(timecard_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_timecard_events" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'timecard_id' is set
        if ('timecard_id' not in params) or (params['timecard_id'] is None):
            raise ValueError("Missing the required parameter `timecard_id` when calling `v1_list_timecard_events`")
    ...
    def v1_list_timecards(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_list_timecards(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_list_timecards" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'limit' in params and params['limit'] > 200:
            raise ValueError("Invalid value for parameter `limit` when calling `v1_list_timecards`, must be a value less than or equal to  `200`")
    ...
    def v1_retrieve_cash_drawer_shift(self, location_id, shift_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_cash_drawer_shift(location_id, shift_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_cash_drawer_shift" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'location_id' is set
        if ('location_id' not in params) or (params['location_id'] is None):
            raise ValueError("Missing the required parameter `location_id` when calling `v1_retrieve_cash_drawer_shift`")
        # verify the required parameter 'shift_id' is set
        if ('shift_id' not in params) or (params['shift_id'] is None):
            raise ValueError("Missing the required parameter `shift_id` when calling `v1_retrieve_cash_drawer_shift`")
    ...
    def v1_retrieve_employee(self, employee_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_employee(employee_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_employee" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('employee_id' not in params) or (params['employee_id'] is None):
            raise ValueError("Missing the required parameter `employee_id` when calling `v1_retrieve_employee`")
    ...
    def v1_retrieve_employee_role(self, role_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_employee_role(role_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_employee_role" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('role_id' not in params) or (params['role_id'] is None):
            raise ValueError("Missing the required parameter `role_id` when calling `v1_retrieve_employee_role`")
    ...
    def v1_retrieve_timecard(self, timecard_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_retrieve_timecard(timecard_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_retrieve_timecard" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'timecard_id' is set
        if ('timecard_id' not in params) or (params['timecard_id'] is None):
            raise ValueError("Missing the required parameter `timecard_id` when calling `v1_retrieve_timecard`")
    ...
    def v1_update_employee(self, employee_id, body, **kwargs):
        """
        v1UpdateEmployee
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_update_employee(employee_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_update_employee" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'employee_id' is set
        if ('employee_id' not in params) or (params['employee_id'] is None):
            raise ValueError("Missing the required parameter `employee_id` when calling `v1_update_employee`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_update_employee`")
    ...
    def v1_update_employee_role(self, role_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_update_employee_role(role_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_update_employee_role" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'role_id' is set
        if ('role_id' not in params) or (params['role_id'] is None):
            raise ValueError("Missing the required parameter `role_id` when calling `v1_update_employee_role`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_update_employee_role`")
    ...
    def v1_update_timecard(self, timecard_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.v1_update_timecard(timecard_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_update_timecard" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'timecard_id' is set
        if ('timecard_id' not in params) or (params['timecard_id'] is None):
            raise ValueError("Missing the required parameter `timecard_id` when calling `v1_update_timecard`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1_update_timecard`")
