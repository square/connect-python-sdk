...
class CatalogItemVariation(object):
    ...
    """
    def __init__(self, item_id=None, name=None, sku=None, upc=None, ordinal=None, pricing_type=None, price_money=None, location_overrides=None, track_inventory=None, inventory_alert_type=None, inventory_alert_threshold=None, user_data=None, service_duration=None, item_option_values=None, measurement_unit_id=None):
        """
    ...
    def item_option_values(self, item_option_values):
        ...
        :type: list[CatalogItemOptionValueForItemVariation]
        """
