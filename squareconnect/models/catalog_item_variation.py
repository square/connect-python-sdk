...
class CatalogItemVariation(object):
    ...
    """
    def __init__(self, item_id=None, name=None, sku=None, upc=None, ordinal=None, pricing_type=None, price_money=None, location_overrides=None, track_inventory=None, inventory_alert_type=None, inventory_alert_threshold=None, buyer_facing_name=None, user_data=None, service_duration=None):
        """
    ...
    def item_id(self):
        ...
        The id of the item associated with this variation.
    ...
    def upc(self):
        ...
        The item variation's UPC, if any.
    ...
    def buyer_facing_name(self):
        """
        Gets the buyer_facing_name of this CatalogItemVariation.
        TODO not in v1

        :return: The buyer_facing_name of this CatalogItemVariation.
        :rtype: str
        """
    ...
    def buyer_facing_name(self, buyer_facing_name):
        """
        Sets the buyer_facing_name of this CatalogItemVariation.
        TODO not in v1

        :param buyer_facing_name: The buyer_facing_name of this CatalogItemVariation.
        :type: str
        """
    ...
    def service_duration(self):
        ...
        If the Item that owns this Item Variation is of type `APPOINTMENTS_SERVICE`, then this is the duration of the service in milliseconds. For example, a 30 minute appointment would have the value `1800000`, which is equal to 30 (minutes) * 60 (seconds per minute) * 1000 (milliseconds per second).
