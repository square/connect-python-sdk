...
class Customer(object):
    ...
    """
    def __init__(self, id=None, created_at=None, updated_at=None, cards=None, given_name=None, family_name=None, nickname=None, company_name=None, email_address=None, address=None, phone_number=None, reference_id=None, note=None, preferences=None, groups=None, creation_source=None):
        """
