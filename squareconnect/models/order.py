...
class Order(object):
    ...
    """
    def __init__(self, id=None, location_id=None, reference_id=None, source=None, customer_id=None, line_items=None, taxes=None, discounts=None, fulfillments=None, returns=None, return_amounts=None, net_amounts=None, rounding_adjustment=None, tenders=None, refunds=None, created_at=None, updated_at=None, closed_at=None, state=None, total_money=None, total_tax_money=None, total_discount_money=None):
        """
