...
class Order(object):
    ...
    """
    def __init__(self, id=None, location_id=None, reference_id=None, line_items=None, taxes=None, discounts=None, fulfillments=None, total_money=None, total_tax_money=None, total_discount_money=None):
        """
