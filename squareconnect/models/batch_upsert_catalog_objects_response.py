...
class BatchUpsertCatalogObjectsResponse(object):
    ...
    """
    def __init__(self, errors=None, objects=None, updated_at=None):
        """
        ...
        self.swagger_types = {
            'errors': 'list[Error]',
            'objects': 'list[CatalogUpsertResponseEntry]',
            'updated_at': 'str'
        }
    ...
    def objects(self):
        ...
        The created [CatalogObject](#type-catalogobject)s, each associated with its client ID. A [CatalogUpsertResponseEntry](#type-catalogupsertresponseentry) will be returned for each object in the request.

        :return: The objects of this BatchUpsertCatalogObjectsResponse.
        :rtype: list[CatalogUpsertResponseEntry]
        """
    ...
    def objects(self, objects):
        ...
        :type: list[CatalogUpsertResponseEntry]
        """
