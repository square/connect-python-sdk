...
class CatalogTax(object):
    ...
    """
    def __init__(self, name=None, calculation_phase=None, inclusion_type=None, percentage=None, applies_to_custom_amounts=None, enabled=None, tax_type_id=None, tax_type_name=None, amount=None):
        """
    ...
    def enabled(self):
        ...
        If `true`, the tax will be shown as enabled in Square Register.
    ...
    def tax_type_id(self):
        """
        Gets the tax_type_id of this CatalogTax.
        A Square-defined string identifying the type of the tax, e.g., `\"us_sales_tax\"` not in v1 TODO(rice)

        :return: The tax_type_id of this CatalogTax.
        :rtype: str
        """
    ...
    def tax_type_id(self, tax_type_id):
        """
        Sets the tax_type_id of this CatalogTax.
        A Square-defined string identifying the type of the tax, e.g., `\"us_sales_tax\"` not in v1 TODO(rice)

        :param tax_type_id: The tax_type_id of this CatalogTax.
        :type: str
        """
    ...
    def tax_type_name(self):
        """
        Gets the tax_type_name of this CatalogTax.
        A Square-defined string identifying the type of the tax, e.g., `\"Sales Tax`\". not in v1

        :return: The tax_type_name of this CatalogTax.
        :rtype: str
        """
    ...
    def tax_type_name(self, tax_type_name):
        """
        Sets the tax_type_name of this CatalogTax.
        A Square-defined string identifying the type of the tax, e.g., `\"Sales Tax`\". not in v1

        :param tax_type_name: The tax_type_name of this CatalogTax.
        :type: str
        """
    ...
    def amount(self):
        """
        Gets the amount of this CatalogTax.
        For flat fees, the amount of the fee. Deprecated.

        :return: The amount of this CatalogTax.
        :rtype: Money
        """
        return self._amount
    ...
    def amount(self, amount):
        """
        Sets the amount of this CatalogTax.
        For flat fees, the amount of the fee. Deprecated.

        :param amount: The amount of this CatalogTax.
        :type: Money
        """
