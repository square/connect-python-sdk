...
class V1UpdateModifierListRequest(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, name=None, selection_type=None):
        """
        V1UpdateModifierListRequest - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this V1UpdateModifierListRequest.
        The modifier list's name.

        :return: The name of this V1UpdateModifierListRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this V1UpdateModifierListRequest.
        The modifier list's name.

        :param name: The name of this V1UpdateModifierListRequest.
        :type: str
        """
