...
class OrderReturnLineItemModifier(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, uid=None, source_modifier_uid=None, catalog_object_id=None, name=None, base_price_money=None, total_price_money=None):
        """
        OrderReturnLineItemModifier - a model defined in Swagger
    ...
    def source_modifier_uid(self, source_modifier_uid):
        ...
        if source_modifier_uid is None:
            raise ValueError("Invalid value for `source_modifier_uid`, must not be `None`")
        if len(source_modifier_uid) > 60:
            raise ValueError("Invalid value for `source_modifier_uid`, length must be less than `60`")
