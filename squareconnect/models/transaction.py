...
class Transaction(object):
    ...
    """
    def __init__(self, id=None, location_id=None, created_at=None, tenders=None, refunds=None, reference_id=None, product=None, client_id=None, shipping_address=None):
        """
