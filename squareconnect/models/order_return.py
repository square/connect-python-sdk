...
class OrderReturn(object):
    ...
    """
    def __init__(self, uid=None, source_order_id=None, return_line_items=None, return_taxes=None, return_discounts=None, rounding_adjustment=None, return_amounts=None):
        """
