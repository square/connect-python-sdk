...
class OrderLineItem(object):
    ...
    """
    def __init__(self, id=None, name=None, quantity=None, taxes=None, discounts=None, base_price_money=None, total_tax_money=None, total_discount_money=None, total_money=None):
        """
