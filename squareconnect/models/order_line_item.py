...
class OrderLineItem(object):
    ...
    """
    def __init__(self, uid=None, name=None, quantity=None, quantity_unit=None, note=None, catalog_object_id=None, variation_name=None, modifiers=None, taxes=None, discounts=None, base_price_money=None, variation_total_price_money=None, gross_sales_money=None, total_tax_money=None, total_discount_money=None, total_money=None):
        """
