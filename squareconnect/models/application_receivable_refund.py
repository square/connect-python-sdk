...
class ApplicationReceivableRefund(object):
    """
    ...
    def __init__(self, id=None, receivable_id=None, refund_id=None, transaction_location_id=None, amount_money=None, created_at=None):
        """
        ApplicationReceivableRefund - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this ApplicationReceivableRefund.
        The receivable refund's unique ID, issued by Square payments servers.

        :return: The id of this ApplicationReceivableRefund.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this ApplicationReceivableRefund.
        The receivable refund's unique ID, issued by Square payments servers.

        :param id: The id of this ApplicationReceivableRefund.
        :type: str
        """
    ...
    def receivable_id(self):
        """
        Gets the receivable_id of this ApplicationReceivableRefund.
        The ID of the receivable that the refund was applied to.

        :return: The receivable_id of this ApplicationReceivableRefund.
        :rtype: str
        """
    ...
    def receivable_id(self, receivable_id):
        """
        Sets the receivable_id of this ApplicationReceivableRefund.
        The ID of the receivable that the refund was applied to.

        :param receivable_id: The receivable_id of this ApplicationReceivableRefund.
        :type: str
        """
    ...
    def refund_id(self):
        """
        Gets the refund_id of this ApplicationReceivableRefund.
        The ID of the refund that is associated to this receivable refund.

        :return: The refund_id of this ApplicationReceivableRefund.
        :rtype: str
        """
    ...
    def refund_id(self, refund_id):
        """
        Sets the refund_id of this ApplicationReceivableRefund.
        The ID of the refund that is associated to this receivable refund.

        :param refund_id: The refund_id of this ApplicationReceivableRefund.
        :type: str
        """
    ...
    def transaction_location_id(self):
        """
        Gets the transaction_location_id of this ApplicationReceivableRefund.
        The ID of the location that created the receivable. This is the location ID on the associated transaction.

        :return: The transaction_location_id of this ApplicationReceivableRefund.
        :rtype: str
        """
    ...
    def transaction_location_id(self, transaction_location_id):
        """
        Sets the transaction_location_id of this ApplicationReceivableRefund.
        The ID of the location that created the receivable. This is the location ID on the associated transaction.

        :param transaction_location_id: The transaction_location_id of this ApplicationReceivableRefund.
        :type: str
        """
    ...
    def amount_money(self):
        """
        Gets the amount_money of this ApplicationReceivableRefund.
        The amount of the refund. This will always be non-negative.

        :return: The amount_money of this ApplicationReceivableRefund.
        :rtype: Money
        """
    ...
    def amount_money(self, amount_money):
        """
        Sets the amount_money of this ApplicationReceivableRefund.
        The amount of the refund. This will always be non-negative.

        :param amount_money: The amount_money of this ApplicationReceivableRefund.
        :type: Money
        """
    ...
    def created_at(self):
        """
        Gets the created_at of this ApplicationReceivableRefund.
        The time when the refund was created, in RFC 3339 format.

        :return: The created_at of this ApplicationReceivableRefund.
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        """
        Sets the created_at of this ApplicationReceivableRefund.
        The time when the refund was created, in RFC 3339 format.

        :param created_at: The created_at of this ApplicationReceivableRefund.
        :type: str
        """
