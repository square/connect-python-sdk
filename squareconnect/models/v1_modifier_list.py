...
class V1ModifierList(object):
    ...
    """
    def __init__(self, id=None, name=None, selection_type=None, modifier_options=None, v2_id=None):
        """
    ...
    def v2_id(self):
        """
        Gets the v2_id of this V1ModifierList.
        The ID of the CatalogObject in the Connect v2 API. Objects that are shared across multiple locations share the same v2 ID.

        :return: The v2_id of this V1ModifierList.
        :rtype: str
        """
        return self._v2_id
    ...
    def v2_id(self, v2_id):
        """
        Sets the v2_id of this V1ModifierList.
        The ID of the CatalogObject in the Connect v2 API. Objects that are shared across multiple locations share the same v2 ID.

        :param v2_id: The v2_id of this V1ModifierList.
        :type: str
        """
