...
class BatchRetrieveCatalogObjectsRequest(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, object_ids=None, include_related_objects=None):
        """
        BatchRetrieveCatalogObjectsRequest - a model defined in Swagger
