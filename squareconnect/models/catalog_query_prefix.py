...
class CatalogQueryPrefix(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, attribute_name=None, attribute_prefix=None):
        """
        CatalogQueryPrefix - a model defined in Swagger
