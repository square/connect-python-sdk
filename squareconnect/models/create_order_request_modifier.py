...
class CreateOrderRequestModifier(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, catalog_object_id=None, name=None, base_price_money=None):
        """
        CreateOrderRequestModifier - a model defined in Swagger
    ...
    def catalog_object_id(self):
        """
        Gets the catalog_object_id of this CreateOrderRequestModifier.
        The catalog object ID of a [CatalogModifier](#type-catalogmodifier).

        :return: The catalog_object_id of this CreateOrderRequestModifier.
        :rtype: str
        """
    ...
    def catalog_object_id(self, catalog_object_id):
        """
        Sets the catalog_object_id of this CreateOrderRequestModifier.
        The catalog object ID of a [CatalogModifier](#type-catalogmodifier).

        :param catalog_object_id: The catalog_object_id of this CreateOrderRequestModifier.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this CreateOrderRequestModifier.
        ...
        :return: The name of this CreateOrderRequestModifier.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this CreateOrderRequestModifier.
        Only used for ad hoc modifiers. The name of the modifier. `name` cannot exceed 255 characters.  Do not provide a value for `name` if you provide a value for `catalog_object_id`.

        :param name: The name of this CreateOrderRequestModifier.
        :type: str
        """
