...
class CreateCheckoutRequest(object):
    ...
    """
    def __init__(self, idempotency_key=None, order=None, ask_for_shipping_address=None, merchant_support_email=None, pre_populate_buyer_email=None, pre_populate_shipping_address=None, redirect_url=None):
        """
    ...
    def pre_populate_buyer_email(self, pre_populate_buyer_email):
        ...
        if not pre_populate_buyer_email:
