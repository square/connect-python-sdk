...
class CatalogItem(object):
    ...
    """
    def __init__(self, name=None, description=None, abbreviation=None, label_color=None, is_taxable=None, visibility=None, available_online=None, available_for_pickup=None, available_electronically=None, category_id=None, buyer_facing_name=None, ordinal=None, tax_ids=None, modifier_list_info=None, image_url=None, variations=None, product_type=None, skip_modifier_screen=None):
        """
        ...
        self._buyer_facing_name = buyer_facing_name
    ...
    def is_taxable(self):
        """
        Gets the is_taxable of this CatalogItem.
        Whether the item is taxable. not in v1

        :return: The is_taxable of this CatalogItem.
        :rtype: bool
        """
    ...
    def is_taxable(self, is_taxable):
        """
        Sets the is_taxable of this CatalogItem.
        Whether the item is taxable. not in v1

        :param is_taxable: The is_taxable of this CatalogItem.
        :type: bool
        """
    ...
    def visibility(self, visibility):
        """
        Sets the visibility of this CatalogItem.
        Indicates whether the item is viewable from the merchant's online store (`PUBLIC`) or `PRIVATE`.

        :param visibility: The visibility of this CatalogItem.
        :type: str
        """
    ...
    def available_electronically(self):
        ...
        If `true`, the item can be added to electronically fulfilled orders from the merchant's online store. not in v1
    ...
    @property
    def buyer_facing_name(self):
        """
        Gets the buyer_facing_name of this CatalogItem.
        TODO not in v1

        :return: The buyer_facing_name of this CatalogItem.
        :rtype: str
        """
        return self._buyer_facing_name

    @buyer_facing_name.setter
    def buyer_facing_name(self, buyer_facing_name):
        """
        Sets the buyer_facing_name of this CatalogItem.
        TODO not in v1

        :param buyer_facing_name: The buyer_facing_name of this CatalogItem.
        :type: str
        """
    ...
    def ordinal(self):
        """
        Gets the ordinal of this CatalogItem.
        TODO not in v1

        :return: The ordinal of this CatalogItem.
        :rtype: int
        """
    ...
    def ordinal(self, ordinal):
        """
        Sets the ordinal of this CatalogItem.
        TODO not in v1

        :param ordinal: The ordinal of this CatalogItem.
        :type: int
        """
    ...
    def tax_ids(self):
        ...
        A set of ids indicating the [CatalogTax](#type-catalogtax)es that are enabled for this item. When updating an item, any taxes listed here will be added to the item. To delete a tax from an item, use `UpdateItemTaxes`.
    ...
    def modifier_list_info(self):
        ...
        A set of [CatalogItemModifierListInfo](#type-catalogitemmodifierlistinfo) objects representing the modifier lists that apply to this item, along with the overrides and min and max limits that are specific to this Item.
    ...
    def skip_modifier_screen(self):
        ...
        If `false`, Square Register will present the Item's details screen immediately, allowing the merchant to choose Modifiers before adding the Item to the cart.  This is the default behavior.  If `true`, Square Register will immediately add the Item to the cart with the pre-selected Modifiers, and merchants can edit modifiers by drilling down onto the Item's details.  Third-party clients are encouraged to implement similar behaviors.
