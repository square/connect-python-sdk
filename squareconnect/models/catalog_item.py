...
class CatalogItem(object):
    ...
    """
    def __init__(self, name=None, description=None, abbreviation=None, label_color=None, available_online=None, available_for_pickup=None, available_electronically=None, category_id=None, tax_ids=None, modifier_list_info=None, variations=None, product_type=None, skip_modifier_screen=None):
        """
