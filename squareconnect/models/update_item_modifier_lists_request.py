...
class UpdateItemModifierListsRequest(object):
    ...
    def item_ids(self):
        ...
        The [CatalogItem](#type-catalogitem)s whose ModifierLists are being updated.
    ...
    def modifier_lists_to_enable(self):
        ...
        The set of [CatalogModifierList](#type-catalogmodifierlist)s (referenced by ID) to enable for the Item.
    ...
    def modifier_lists_to_disable(self):
        ...
        The set of [CatalogModifierList](#type-catalogmodifierlist)s (referenced by ID) to disable for the Item.
