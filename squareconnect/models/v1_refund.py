...
class V1Refund(object):
    ...
    """
    def __init__(self, type=None, reason=None, refunded_money=None, refunded_processing_fee_money=None, refunded_additive_tax_money=None, refunded_inclusive_tax_money=None, refunded_tip_money=None, refunded_discount_money=None, created_at=None, processed_at=None, payment_id=None, merchant_id=None):
        """
