...
class CatalogObject(object):
    ...
    """
    def __init__(self, type=None, id=None, updated_at=None, version=None, is_deleted=None, custom_attributes=None, location_overrides=None, catalog_v1_ids=None, present_at_all_locations=None, present_at_location_ids=None, absent_at_location_ids=None, item_data=None, category_data=None, item_variation_data=None, tax_data=None, discount_data=None, modifier_list_data=None, modifier_data=None):
        """
        ...
        self.swagger_types = {
            ...
            'version': 'int',
            'is_deleted': 'bool',
            'custom_attributes': 'list[CatalogCustomAttribute]',
            'location_overrides': 'list[CatalogLocationOverrides]',
    ...
    def type(self):
        ...
        Possible kinds of objects returned from the Catalog, each with corresponding expected properties as defined by each `*_data` property inside the returned outer [CatalogObjectType](#type-catalogobjecttype).  See [CatalogObjectType](#type-catalogobjecttype) for all possible values.
    ...
    def updated_at(self):
        ...
        Last modification [timestamp](#workingwithdates) in RFC 3339 format, e.g., 2016-08-15T23:59:33.123Z would indicate the UTC time August 15, 2016 at 23:59:33 and 123 milliseconds.
    ...
    def custom_attributes(self):
        """
        Gets the custom_attributes of this CatalogObject.
        Key/value attributes that are set at a global (location-independent) level. Values from the `*_data` fields may not be duplicated.

        :return: The custom_attributes of this CatalogObject.
        :rtype: list[CatalogCustomAttribute]
        """
    ...
    def custom_attributes(self, custom_attributes):
        """
        Sets the custom_attributes of this CatalogObject.
        Key/value attributes that are set at a global (location-independent) level. Values from the `*_data` fields may not be duplicated.

        :param custom_attributes: The custom_attributes of this CatalogObject.
        :type: list[CatalogCustomAttribute]
        """
    ...
    def location_overrides(self):
        """
        Gets the location_overrides of this CatalogObject.
        A set of custom attributes that have been overridden at specific locations.

        :return: The location_overrides of this CatalogObject.
        :rtype: list[CatalogLocationOverrides]
        """
    ...
    def location_overrides(self, location_overrides):
        """
        Sets the location_overrides of this CatalogObject.
        A set of custom attributes that have been overridden at specific locations.

        :param location_overrides: The location_overrides of this CatalogObject.
        :type: list[CatalogLocationOverrides]
        """
