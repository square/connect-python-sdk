...
class PreviewRedeemCouponRequest(object):
    """
    ...
    def __init__(self, idempotency_key=None):
        """
        PreviewRedeemCouponRequest - a model defined in Swagger
    ...
    def idempotency_key(self):
        """
        Gets the idempotency_key of this PreviewRedeemCouponRequest.
        ...
        :return: The idempotency_key of this PreviewRedeemCouponRequest.
        :rtype: str
        """
    ...
    def idempotency_key(self, idempotency_key):
        """
        Sets the idempotency_key of this PreviewRedeemCouponRequest.
        Unique identifier. Multiple API calls with the same identifier will result in the same response.  See [Idempotency keys](#idempotencykeys) for more information.

        :param idempotency_key: The idempotency_key of this PreviewRedeemCouponRequest.
        :type: str
        """
