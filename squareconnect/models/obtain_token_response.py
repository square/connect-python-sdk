...
class ObtainTokenResponse(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, access_token=None, token_type=None, expires_at=None, merchant_id=None, subscription_id=None, plan_id=None, id_token=None, refresh_token=None):
        """
        ObtainTokenResponse - a model defined in Swagger
