...
class UpdateCustomerRequest(object):
    ...
    """
    def __init__(self, given_name=None, family_name=None, company_name=None, nickname=None, email_address=None, address=None, phone_number=None, reference_id=None, note=None, birthday=None):
        """
