...
class Location(object):
    ...
    """
    def __init__(self, id=None, name=None, address=None, timezone=None, capabilities=None, status=None, created_at=None, merchant_id=None, country=None, language_code=None, currency=None, phone_number=None, business_name=None, type=None):
        """
